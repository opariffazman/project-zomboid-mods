...
local function new_onPlumbItem(worldobjects, player, itemToPipe)
...
function ISWorldObjectContextMenu.createMenu(player, worldobjects, x, y, test)
  ...
  if canBeWaterPiped then
    ...
    local option = context:addOptionOnTop(getText("ContextMenu_PlumbItemITCP", name), worldobjects, new_onPlumbItem, player, canBeWaterPiped)
